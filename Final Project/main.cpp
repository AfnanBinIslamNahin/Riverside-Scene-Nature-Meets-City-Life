...
void waves()
{
    ...
    glTranslatef(-_move10,-_move10,0);
    ...
    glTranslatef(_move11,-_move11,0);
    glBegin(GL_LINES);
    glColor3ub(255, 0255, 0);
    glVertex2d(-7,-35-110);
    glVertex2d(4,-70-110);
...
void modifiedTree(int x1,int y1,int x2,int y2,int x3,int y3){
    glBegin(GL_POLYGON);
    glColor3ub(0, 128, 0);
    glVertex2d(x1,y1);
    glVertex2d(x2,y2);
  ...
  glBegin(GL_POLYGON);
    glColor3ub(128, 0, 0);
    glVertex2d(x1-2,y2-8);
    glVertex2d(x1-2,y2-15);
    glVertex2d(x1+2,y2-15);
    glVertex2d(x1+2,y2-8);
    glEnd();
...
void tree_2()
{
 glLineWidth(3);
    ...
    CircleBorder(18,40+60, 7,3,0,0,0);

    Circle(18, 100+60,7,0,176,65);
    CircleBorder(18,100+60, 7,3,0,0,0);

    Circle(30, 70+60,28,0,176,65);
    CircleBorder(30,70+60, 28,3,0,0,0);

    Circle(10, 63+60,00,0,176,65);
    CircleBorder(10,63+60, 00,3,0,0,0);

    Circle(10, 77+60,00,0,176,65);
    CircleBorder(10,77+60, 00,3,0,0,0);
...
void windmill_1()
{
    ...
    glBegin(GL_LINES);
    glColor3ub(255, 255, 255);
    glVertex2d(52.5,0+50);
    glVertex2d(52.5,40+50);
    glEnd();
    ...
    Circle(5,52.5,50,200, 199, 199);
    CircleBorder(5,52.5,50,1,0,0,0);
    glPopMatrix();
}
...
void windmill_2()
{
    ...
    Circle(5,0,63,200, 200, 200);
    CircleBorder(5,0,63,1,0,0,0);
    glPopMatrix();
}

void rotate_1(int value)
{
    _angle1+=2.0f;
    if(_angle1 > 360.0)
    {
...
void Train()
{
    ...
    glVertex2f(-230.0f+TrainPosition, -9.0f);
    ...
    glVertex2f(-202.5f+TrainPosition, 7.0f);
    glVertex2f(-212.5f+TrainPosition, -1.0f);
    glVertex2f(-112.5f+TrainPosition, -1.0f);
    ...
    glBegin(GL_POLYGON);
    glColor3ub(139, 0, 0);
    glVertex2f(-160.5f+TrainPosition,22.0f);
    glVertex2f(-175.5f+TrainPosition, 7.0f);
    glVertex2f(-112.5f+TrainPosition, 7.0f);
  ...
  glBegin(GL_POLYGON);
    glColor3ub(1,1,1);
    glVertex2f(-162.5+5+TrainPosition, 20.0f);
    glVertex2f(-162.5+5+TrainPosition, 8.0f);
    glVertex2f(-155.5+15+TrainPosition, 8.0f);
    glVertex2f(-155.5+15+TrainPosition, 20.0f);
    glEnd();
    ...
    glBegin(GL_POLYGON);
    glColor3ub(1,1,1);
    glVertex2f(-140.5+5+TrainPosition, 20.0f);
    glVertex2f(-140.5+5+TrainPosition, 8.0f);
    glVertex2f(-132.5+15+TrainPosition, 8.0f);
    glVertex2f(-132.5+15+TrainPosition, 20.0f);
    glEnd();

    glLineWidth(1.0);
    circle(7, 0 - 200+TrainPosition, 0 - 6, 0, 0, 0);
    glEnd();

    glLineWidth(1.0);
    circle(7, 0 - 200+20+TrainPosition, 0 - 6, 0, 0, 0);
    glEnd();

    glLineWidth(1.0);
    circle(7, 0 - 200+50+TrainPosition, 0 - 6, 0, 0, 0);
    glEnd();

    glLineWidth(1.0);
    circle(7, 0 - 200+70+TrainPosition, 0 - 6, 0, 0, 0);
    glEnd();
    ...
    glLineWidth(1.0);
    circle(4, 0 - 80+TrainPosition, 0 - 9, 0, 0, 0);
    glEnd();

    glLineWidth(1.0);
    circle(4, 0 - 60+TrainPosition, 0 - 9, 0, 0, 0);
    glEnd();

    glLineWidth(1.0);
    circle(4, 0 - 80+50+TrainPosition, 0 - 9, 0, 0, 0);
    glEnd();

    glLineWidth(1.0);
    circle(4, 0 - 60+50+TrainPosition, 0 - 9, 0, 0, 0);
    glEnd();
    ...
    glLineWidth(1.0);
    circle(4, 0 - 80+112+TrainPosition, 0 - 9, 0, 0, 0);
    glEnd();

    glLineWidth(1.0);
    circle(4, 0 - 60+112+TrainPosition, 0 - 9, 0, 0, 0);
    glEnd();

    glLineWidth(1.0);
    circle(4, 0 - 80+50+112+TrainPosition, 0 - 9, 0, 0, 0);
    glEnd();

    glLineWidth(1.0);
    circle(4, 0 - 60+50+112+TrainPosition, 0 - 9, 0, 0, 0);
    glEnd();
    ...
    glLineWidth(1.0);
    circle(4, 0 - 80+224+TrainPosition, 0 - 9, 0, 0, 0);
    glEnd();

    glLineWidth(1.0);
    circle(4, 0 - 60+224+TrainPosition, 0 - 9, 0, 0, 0);
    glEnd();

    glLineWidth(1.0);
    circle(4, 0 - 80+50+224+TrainPosition, 0 - 9, 0, 0, 0);
    glEnd();

    glLineWidth(1.0);
    circle(4, 0 - 60+50+224+TrainPosition, 0 - 9, 0, 0, 0);
    glEnd();
}
...
void car1()
{
    ...
    glVertex2f(-220.0f + car1Position, -15.0f);
    glVertex2f(-225.0f + car1Position, -27.0f);
    glVertex2f(-167.5f + car1Position, -27.0f);
    glVertex2f(-175.0f + car1Position, -15.0f);
    glEnd();

    glBegin(GL_POLYGON);
    glColor3ub(0, 255, 255);
    glVertex2f(-203.0f + car1Position, -7.0f);
    glVertex2f(-208.75f + car1Position, -15.0f);
    glVertex2f(-183.5f + car1Position, -15.0f);
    glVertex2f(-188.0f + car1Position, -7.0f);
    glEnd();

    glBegin(GL_POLYGON);
    glColor3ub(255, 191, 0);
    glVertex2f(-198.0f + car1Position, -7.0f);
    glVertex2f(-198.0f + car1Position, -15.0f);
    glVertex2f(-195.5f + car1Position, -15.0f);
    glVertex2f(-195.5f + car1Position, -7.0f);
    glEnd();

    glBegin(GL_LINES);
    glColor3f(0.0f, 0.0f, 0.0f);
    glVertex2f(-208.0f + car1Position, -15.0f);
    glVertex2f(-183.0f + car1Position, -15.0f);
    glEnd();

    glLineWidth(1.0);
    circle(3.5, 0 - 215 + car1Position, 0 - 27, 20, 20, 20);
    glEnd();

    glLineWidth(1.0);
    circle(3.5, 0 - 182 + car1Position, 0 - 27, 20, 20, 20);
    glEnd();
}
...
void car2()
{
    ...
    glLineWidth(1.0);
    circle(3.5,0-112.5+car2Position,0-43,20, 20, 20);
    glEnd();

    glLineWidth(1.0);
    circle(3.5,0-80+car2Position,0-43,20, 20, 20);
    glEnd();
}
...
void car3()
{
    glBegin(GL_POLYGON);
    glColor3ub(  135, 206, 250);
    glVertex2f(-220.0+200.0+car3Position, -15.0);
    glVertex2f(-225.0+200.0+car3Position, -27.0);
    glVertex2f(-167.5+200.0+car3Position, -27.0f);
    glVertex2f(-175.0+200.0+car3Position, -15.0f);
    glEnd();

    glBegin(GL_POLYGON);
    glColor3ub(135, 206, 250);
    glVertex2f(-203.0+200.0+car3Position, -7.0);
    glVertex2f(-208.75+200.0+car3Position, -15.0);
    glVertex2f(-183.5+200.0+car3Position, -15.0);
    glVertex2f(-188.0+200.0+car3Position, -7.0);
    glEnd();

    glBegin(GL_POLYGON);
    glColor3ub(255,191,0);
    glVertex2f(-198.0+200.0+car3Position, -7.0);
    glVertex2f(-198.0+200.0+car3Position, -15.0);
    glVertex2f(-195.5+200.0+car3Position, -15.0);
    glVertex2f(-195.5+200.0+car3Position, -7.0);
    glEnd();

    glBegin(GL_LINES);
    glColor3f(0.0f,0.0f, 0.0f);
    glVertex2f(-208.0+200.0+car3Position,-15.0f);
    glVertex2f(183.0+200.0+car3Position, -15.0f);
    glEnd();

    glLineWidth(1.0);
    circle(3.5,0-8+car3Position,0-27,20, 20, 20);
    glEnd();

    glLineWidth(1.0);
    circle(3.5,0+17+car3Position,0-27 ,20, 20, 20);
    glEnd();
}
...
void car4()
{
    ...
    glLineWidth(1.0);
    circle(3.5,0+90+car4Position,0-43,20, 20, 20);
    glEnd();

    glLineWidth(1.0);
    circle(3.5,0+117+car4Position,0-43,20, 20, 20);
    glEnd();
}
...
void car5()
{
    ...
    glLineWidth(1.0);
    circle(3.5,0+188+car5Position,0-43,20, 20, 20);
    glEnd();

    glLineWidth(1.0);
    circle(3.5,0+218+car5Position,0-43,20, 20, 20);
    glEnd();
}
...
{glPushMatrix();
    ...
    glVertex2d(-0.1092029317918, -191.403266380433);
    ...
    glVertex2d(44.0083056919183, -191.9506726337237);
 ...
 glBegin(GL_POLYGON);
    ...
    glVertex2d(97.8253485369383, -192.4240742613158);
    ...
    glVertex2d(220.0297577682238, -191.9722367735132);
    ...
    glVertex2d(150, -193.0929569457987);
...
void DamSideBoat()
{
    ...
    glBegin(GL_QUADS);
    glColor3ub(139, 69, 19);
    glVertex2f(220, -170.5);
    glVertex2f(210, -160.5);
    glVertex2f(170.50, -160.5);
    glVertex2f(180.0, -170.5);
    glEnd();

    glBegin(GL_QUADS);
    glColor3ub(0, 0, 0);
    glVertex2f(220.0, -180.0);
    glVertex2f(220.0, -170.5);
    glVertex2f(170.0, -170.5);
    glVertex2f(170.0, -180.0);
    glEnd();

    glBegin(GL_QUADS);
    glColor3ub(255, 99, 71);
    glVertex2f(200.5, -160.5);
    glVertex2f(210.0, -140.5);
    glVertex2f(180.5, -140.5);
    glVertex2f(180.0, -160.5);
    glEnd();


    glBegin(GL_QUADS);
    glColor3ub(139, 69, 19);
    glVertex2f(190.8, -140.5);
    glVertex2f(190.8, -140.0);
    glVertex2f(190.7, -140.0);
    glVertex2f(190.7, -140.5);
    glEnd();
    ...
    glVertex2f(220.0, -170.5);
    glVertex2f(220.0, -180.0);
    glVertex2f(230.5, -170.2);
    glEnd();

    glBegin(GL_TRIANGLES);
    glColor3ub(0, 0, 0);
    glVertex2f(165.0, -170.5);
    glVertex2f(180.0, -170.5);
    glVertex2f(170.5, -160.5);
    glEnd();
...
glVertex2d(-52.7044919735443, -158.2027085797572);
glVertex2d(-25.9759936197429, -191.7348800358089);
...
glVertex2d(-229.3459112027604, -194.1733677964389);
...
glVertex2d(-235.6017162160799, -192.8729471464556);
glVertex2d(-205, -185);
...
glVertex2d(-189.2831587053754, -194.2974953551886);
...
glColor3ub(11, 114, 69);
glVertex2d(-200.1304093994371, -182.6880397528533);
glVertex2d(-205.3164343,-184.584);
...
glVertex2d(-154.3478332518225, -115.8308908200394);
...
void damWaterfall()
{
    ...
    glTranslatef(1, -moveWaterfall, 0);
...
void damWaterfallClosed()
{
   glPushMatrix();
    ...
    glTranslatef(11.5, -400.728732401509, 0);
    glScalef(1.4,1,0);
    ...
    glTranslatef(65, -400.728732401509, 0);
    glScalef(1.5,1,0);
    ...
    glTranslatef(118, -400.728732401509, 0);
    glScalef(1.5,1,0);
    ...
    glTranslatef(170, -400.728732401509, 0);
    glScalef(1.3,1,0);
    ...
    glTranslatef(213, -400.728732401509, 0);
    glScalef(0.85,1,0);
...
void DamSideBoatAnimation(){ static float boatPositionX = 500.0f;
    boatPositionX -= boatSpeed;

    if (boatPositionX < -500.0f) {
        boatPositionX = 500.0f;
    }

    glPushMatrix();
    glTranslatef(boatPositionX, 0, 0);

     DamSideBoat1();
    glPopMatrix();
 static float boatPositionX1 = -500.0f;
    boatPositionX1 += boatSpeed;

    if (boatPositionX1 > 500.0f) {
        boatPositionX1 = -500.0f;
    }

    glPushMatrix();
    glTranslatef(boatPositionX1, 0, 0);
...
void displayRain() {
    ...
    for (int i = 0; i < MAX_RAIN; i++) {
        ...
        glVertex2f(rain[i].x, rain[i].y - 5);
...
void display()
{
 ...
 glPushMatrix();
    glScalef(0.3,0.3,0);
    glTranslatef(450, 125, 0.0f);
    house1();
    glPopMatrix();

glPushMatrix();
    glScalef(0.5,0.5,0);
    glTranslatef(350, 150, 0.0f);
    tree_2();
    glPopMatrix();
    if(damClosed)
    ...
    building(30.0f, 100.0f, -40.0f, 140.0f, 175, 122, 197);
    building1(30.0f, 80.0f, -95.0f, 130.0f, 229, 152, 102);

    drawBuilding(20.0f, 80.0f, -28.0f, 125.0f, 236, 112, 99);
    drawBuilding(30.0f, 100.0f, -128.0f, 140.0f, 27, 38, 49);
    building(30.0f, 80.0f, -155.0f, 125.0f, 46, 134, 193);
    drawBuilding(20.0f, 100.0f, -67.0f, 140.0f, 46, 64, 83);
    drawHospital(30.0f, 110.0f, -188.0f, 140.0f, 255, 255, 255);
    drawBuilding(20.0f, 70.0f, -75.0f, 120.0f, 243, 156, 18);
    ...
    drawBank(30.0f, 80.0f, -115.0f, 90.0f, 82, 190, 128);
    drawTower(40.0f, 100.0f, 15.0f, 100.0f, 23, 32, 42);

    agriculturalField(85,150,150,150,140,175,85,175,1);
    agriculturalField(200,150,230,150,220,175,190,175,2);

   modifiedTree(90,210,80,190,100,190);
    modifiedTree(60,180,50,160,70,160);
    modifiedTree(45,165,35,145,55,145);
        modifiedTree(-60,60,-70,40,-50,40);

         modifiedTree(-130,60,-140,40,-120,40);

          modifiedTree(-190,60,-200,40,-180,40);


        modifiedTree(20,60,10,40,30,40);
  modifiedTree(120,210,110,190,130,190);

      modifiedTree(90,150,80,130,100,130);

            modifiedTree(105,125,95,105,115,105);

                        modifiedTree(105,125,95,105,115,105);
                        modifiedTree(55,125,45,105,65,105);


                        modifiedTree(95,90,85,70,105,70);



    modifiedTree(50,210,40,190,60,190);
        modifiedTree(25,210,15,190,35,190);
    modifiedTree(-95,210,-105,190,-85,190);

        modifiedTree(-155,210,-165,190,-145,190);
